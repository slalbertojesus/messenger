 ...
 *   !proto.api.PingMessage>}
 */
const methodDescriptor_Ping_YesHello = new grpc.web.MethodDescriptor(
  '/api.Ping/YesHello',
 ...
 *   !proto.api.PingMessage>}
 */
const methodInfo_Ping_YesHello = new grpc.web.AbstractClientBase.MethodInfo(
  proto.api.PingMessage,
  /**
   * @param {!proto.api.PingMessage} request
   * @return {!Uint8Array}
 ...
 */
proto.api.PingClient.prototype.yesHello =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/api.Ping/YesHello',
      request,
      metadata || {},
      methodDescriptor_Ping_YesHello,
      callback);
};
 ...
 */
proto.api.PingPromiseClient.prototype.yesHello =
